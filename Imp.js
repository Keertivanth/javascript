...
function updateObject(obj, newKey, newValue) {
  // STUDENT CODE STARTS HERE
     return {
        ...obj,//pread operator copies all properties from the original object into a new objec
        [newKey]:newValue//This is called computed property name.
                       //It dynamically adds a new key to the object
     };
  // STUDENT CODE ENDS HERE
}
